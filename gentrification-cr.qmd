...
df <- read_csv("ad-hocs/gentrification/plot-inputs/1_small-area-incomes.csv") %>% 
...
df_medians <- read_csv("ad-hocs/gentrification/plot-inputs/1_small-area-incomes.csv") %>% 
  select(MSOA21HCLNM, `2012`, `2020`, income_quintiles_2012 ) %>% 
  group_by(income_quintiles_2012) %>% 
  summarise("Median income 2012" = median(`2012`),
            "Median income 2020" = median(`2020`)) %>% 
...
dfx <- read_csv("ad-hocs/gentrification/plot-inputs/1_small-area-incomes.csv") %>% 
...
df <- read_csv("ad-hocs/gentrification/plot-inputs/2a_biggest-inc-rise-nssec-census.csv") 
...
df <- read_csv("ad-hocs/gentrification/plot-inputs/2c_biggest-inc-rise-age-census.csv") 
...
df <- read_csv("ad-hocs/gentrification/plot-inputs/2b_biggest-inc-rise-ethnicity-census.csv") %>% 
...
df <- read_csv("ad-hocs/gentrification/plot-inputs/2e_biggest-inc-rise-hh-comp-census.csv") 
...
df <- read_csv("ad-hocs/gentrification/plot-inputs/2d_biggest-inc-rise-tenure-census.csv") 
...
df <- read_csv("ad-hocs/gentrification/plot-inputs/3_house-prices.csv") %>% 
  filter(Year != 2024)
...
df <- read_csv("ad-hocs/gentrification/plot-inputs/3_house-prices-inx.csv") %>% 
  select(-`2024_inx`) %>% 
...
#read in the data
df <- read_csv("ad-hocs/gentrification/plot-inputs/4_school_admissions.csv") %>% rename("ONS_CODE" = new_la_code)
